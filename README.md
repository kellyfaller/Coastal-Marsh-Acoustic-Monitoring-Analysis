...
- **Docs**: Documentation, including the [`CITATION.cff`](./Docs/CITATION.cff) file and this README, as well as important methodological documents such as the acoustic montioring manual.
